...
/// Spawn the city map from config JSON (GLB, lighting) +
...
pub fn spawn(
    ...
    let map_data = noctyrn_shared::map_data::load_map_data("city");
    let colliders = noctyrn_shared::map_data::load_colliders("city");
