...
fn spawn_text(mut commands: Commands) {
    ...
    commands.spawn((
        ...
        children![
            ...
            (Text::new("Jump with Space"), font.clone()),
...
fn advance_physics(
        ...
        query.iter_mut()
    {
        ...
        // If we are not pressing any keys, wish_dir is zero, so we don't accelerate.
        // But friction will slow us down.
        ...
        if wish_dir.length_squared() > 0.0 {
            ...
            if add_speed > 0.0 {
                // Air control is usually different, but let's keep it simple for now
